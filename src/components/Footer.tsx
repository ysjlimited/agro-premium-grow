      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-8 py-16 grid gap-12 lg:grid-cols-12">
        <div className="lg:col-span-4 space-y-5">
          ...
          <p className="text-sm leading-relaxed text-muted-foreground max-w-sm">
            YSJ Limited Broiler Farm — a premium commercial poultry and agro enterprise delivering
            hygienic broilers, professional brooding, quality feeds and cash crops since 2016.
          </p>
          <div className="flex gap-3">
            <a
              aria-label="Facebook"
              href="#"
              className="grid h-10 w-10 place-items-center rounded-full border border-border bg-card hover:bg-secondary transition"
            >
              <Facebook size={16} />
            </a>
            <a
        ...
        <div className="lg:col-span-2">
          <h4 className="text-sm font-semibold uppercase tracking-widest text-primary-deep mb-4">
            Explore
          </h4>
          <ul className="space-y-2 text-sm">
            ...
            <li>
              <Link to="/about" className="hover:text-primary-deep">
                About
              </Link>
            </li>
            <li>
              <Link to="/services" className="hover:text-primary-deep">
                Services & Products
              </Link>
            </li>
            <li>
              <Link to="/contact" className="hover:text-primary-deep">
                Contact
              </Link>
            </li>
          </ul>
        ...
        <div className="lg:col-span-3">
          ...
          <ul className="space-y-3 text-sm text-muted-foreground">
            <li className="flex gap-2">
              <MapPin size={16} className="mt-0.5 text-primary" /> Road 5, Lamona, Oluhunda Akobo,
              Ibadan, Nigeria
            </li>
            <li className="flex gap-2">
              <Phone size={16} className="mt-0.5 text-primary" />{" "}
              <a href="tel:+2349131201229" className="font-mono">
                09131201229
              </a>
            </li>
            <li className="flex gap-2">
              <Mail size={16} className="mt-0.5 text-primary" />{" "}
              <a href="mailto:ysjlimitedbroilerfarm@gmail.com" className="break-all">
                ysjlimitedbroilerfarm@gmail.com
              </a>
            </li>
          </ul>
        </div>
        ...
        <div className="lg:col-span-3">
          ...
          <p className="text-sm text-muted-foreground mb-3">
            Farm updates, seasonal offers and bulk-supply availability.
          </p>
          <form
