  ...
  head: () => ({
    meta: [
      { title: "YSJ Limited Broiler Farm — Premium Poultry & Agro, Ibadan" },
      {
        name: "description",
        content:
          "Premium broiler production, poultry brooding, animal feeds, cashew & maize. Hygienic, professionally managed agro supply from Ibadan, Nigeria.",
      },
      { property: "og:title", content: "YSJ Limited Broiler Farm — Premium Poultry & Agro" },
      {
        property: "og:description",
        content:
          "Hygienic broilers, brooding, feeds and cash crops from a professional commercial farm in Ibadan, Nigeria.",
      },
  ...
  return (
    <SiteShell>
      ...
      <section className="relative overflow-hidden">
        <div
          className="absolute -top-40 -right-40 h-96 w-96 rounded-full bg-gold/20 blur-3xl"
          aria-hidden
        />
        <div
        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-8 py-20 lg:py-28 grid lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-6 space-y-7 reveal">
            ...
            <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold leading-[1.05] tracking-tight">
              Premium <span className="text-gradient-emerald">Broiler Production</span>, Poultry
              Brooding & Agro Supply in Ibadan
            </h1>
            <p className="text-lg text-muted-foreground max-w-xl leading-relaxed">
              YSJ Limited delivers hygienically raised broilers, professional brooding services and
              quality animal feeds — alongside cashew and maize from our 10-acre facility. Trusted
              by traders, processors and households across Oyo State.
            </p>
            <div className="flex flex-wrap gap-3">
              <Link
                to="/contact"
                className="inline-flex items-center gap-2 rounded-full bg-primary-deep px-6 py-3.5 text-sm font-semibold text-primary-foreground shadow-elegant hover:bg-primary transition"
              >
                Request a Quote <ArrowRight size={16} />
              </Link>
              <a
                href="https://wa.me/2349131201229"
                className="inline-flex items-center gap-2 rounded-full border border-border bg-card px-6 py-3.5 text-sm font-semibold hover:bg-secondary transition"
              >
          ...
          <div className="lg:col-span-6 relative reveal">
            <div className="relative rounded-[2rem] overflow-hidden border border-border shadow-elegant">
              <img
                src={hero.url}
                alt="YSJ broiler farm facility at night"
        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          <div className="max-w-2xl mb-14 reveal">
            ...
            <p className="mt-4 text-muted-foreground text-lg">
              From day-old chicks to bulk distribution — every step is monitored with veterinary
              discipline and biosecurity.
            </p>
          </div>
            ...
            {[
              {
                n: "01",
                t: "Brooding",
                d: "Climate-controlled brooding houses for healthy day-old chicks.",
              },
              {
                n: "02",
                t: "Growing",
                d: "Veterinary nutrition with monitored feed conversion ratios.",
              },
              {
                n: "03",
                t: "Processing",
                d: "Hygienic handling under strict biosecurity protocols.",
              },
              {
                n: "04",
                t: "Distribution",
                d: "Wholesale & retail logistics across Oyo and beyond.",
              },
            ].map((step) => (
              <li
                key={step.n}
                className="reveal rounded-3xl border border-border bg-card p-7 hover:-translate-y-1 hover:shadow-elegant transition"
              >
          ...
          {[
            {
              ...
              d: "Controlled-access housing, sanitation protocols and veterinary oversight protect every flock — from day-old to market weight.",
            },
            {
              img: banner.url,
              icon: Leaf,
              t: "Hygienic feed standards",
              d: "We process and source nutritionally balanced feed to deliver consistent weight gain and meat quality.",
              reverse: true,
            },
            {
              img: chicks.url,
              icon: Truck,
              t: "Reliable wholesale supply",
              d: "Bulk orders fulfilled with logistics partners across Oyo State for traders, processors and HORECA buyers.",
            },
          ].map((row, i) => {
            const Icon = row.icon;
            return (
              <div
                key={i}
                className={`grid lg:grid-cols-2 gap-10 lg:gap-16 items-center ${row.reverse ? "lg:[&>div:first-child]:order-2" : ""}`}
              >
                <div className="reveal">
                  <img
                    ...
                    alt=""
                    loading="lazy"
                    className="w-full h-[420px] object-cover rounded-[2rem] border border-border shadow-elegant"
                  />
                </div>
            ...
            {[
              {
                ...
                d: "Healthy, well-finished birds for traders and processors.",
              },
              {
                img: brooding.url,
                icon: ShieldCheck,
                t: "Poultry brooding",
                d: "Specialised brooding for first-week survival rates.",
              },
              {
                img: chicks.url,
                icon: Truck,
                t: "Bulk distribution",
                d: "Reliable wholesale logistics across Oyo State.",
              },
              {
                img: cashew.url,
                icon: Leaf,
                t: "Cashew",
                d: "Cash crop production from our 10-acre facility.",
              },
              {
                img: maize.url,
                icon: Wheat,
                t: "Maize",
                d: "Premium grain for feed and food markets.",
              },
            ].map((s, i) => {
              const Icon = s.icon;
              return (
                <article
                  key={i}
                  className="reveal group relative overflow-hidden rounded-3xl border border-border bg-card hover:-translate-y-1 hover:shadow-elegant transition"
                >
        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          ...
          <div className="columns-2 md:columns-3 lg:columns-4 gap-4 [&>*]:mb-4">
            {[hero, banner, brooding, chicks, cashew, maize, banner, brooding].map((a, i) => (
              <div
                key={i}
                className="overflow-hidden rounded-2xl border border-border break-inside-avoid"
              >
                <img
                  src={a.url}
                  alt=""
                  loading="lazy"
                  className="w-full hover:scale-110 transition duration-700"
                />
              </div>
            ))}
          </div>
            ...
            <div className="relative grid lg:grid-cols-2 gap-10 items-center">
              <div>
                <h2 className="text-3xl lg:text-5xl font-bold leading-tight">
                  Ready to source from a farm you can trust?
                </h2>
                <p className="mt-4 text-primary-foreground/80 text-lg max-w-lg">
                  Bulk broilers, feeds and cash crops — competitively priced, hygienically produced,
              ...
              <div className="flex flex-wrap gap-3 lg:justify-end">
                <Link
                  to="/contact"
                  className="inline-flex items-center gap-2 rounded-full bg-gold text-gold-foreground px-6 py-3.5 text-sm font-semibold hover:opacity-90"
                >
                  Request a Quote <ArrowRight size={16} />
                </Link>
                <a
                  href="https://wa.me/2349131201229"
                  className="inline-flex items-center gap-2 rounded-full border border-white/25 px-6 py-3.5 text-sm font-semibold hover:bg-white/10"
                >
